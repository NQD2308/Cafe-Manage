...
public class JFrList_product extends JFrame {
	...
	public JFrList_product() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(JFrList_product.class.getResource("/manage_cafe/gui/icon/Logo_Coffeeshop.png")));
		setTitle("Warehouse");
//		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		...
		mntmNewMenuItem_6.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null, "Chương trình bao gồm có 6 chức năng chính:\n"
						+ "  + Thêm thông tin hàng hóa mới\n  + Xóa thông tin hàng hóa cũ\n  + Nhập hàng hóa\n  + "
						+ "Xuất hàng hóa\n  + Lưu thông tin hàng hóa\n  + Tìm kiếm thông tin hàng hóa bằng mã",
		...
		mntmNewMenuItem_7.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null, "Đây là chương trình quản lý kho hàng gồm các thực thể:\n  + Mã hàng hóa\n"
						+ "  + Tên hàng hóa\n  + Số lượng hàng hóa trong một thàng\n  + Số hàng hàng sẽ nhập vào kho\n  +"
						+ " Chọn nhập sĩ hoặc lẻ","Entities",JOptionPane.INFORMATION_MESSAGE);
			}
		});
		...
		lbl_title.setIcon(new ImageIcon(JFrList_product.class.getResource("/manage_cafe/gui/icon/warehouse_storage_icon.png")));
		lbl_title.setFont(new Font("Serif", Font.ITALIC, 40));
		lbl_title.setBounds(198, 10, 253, 62);
...
//				System.out.println("Import "+g.getInventnum()+"");
		...
		btn_back.setBounds(20, 20, 63, 24);
