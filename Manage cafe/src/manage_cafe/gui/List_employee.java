...
public class List_employee extends JFrame {
	...
	public List_employee() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(List_employee.class.getResource("/manage_cafe/gui/icon/Logo_Coffeeshop.png")));
		setTitle("Employee Information");
//		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 1238, 670);
		...
		mntmNewMenuItem_7.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null, "Đây là chương trình quản lý nhân viên bao gồm các thông tin sau:\n"
						+ "  - Thông tin cá nhân\n    + Họ và tênTên\n    + CMDD/CCCD\n    + "
						+ "Giới tính\n    + Địa chỉ nhà ở\n    + Địa chỉ Email\n\n  - Thông tin công việc\n"
						+ "    + Mã nhân viên\n    + Vị trí làm việc\n    + Thời gian làm việc\n    + Hình thức làm việc: "
						+ "toàn thời gian hay bán thời gian\n    + Ngày bắt đầu làm việc\n    + Lương nhân viên\n    + "
						+ "Lập tài khoản\n    + Lập password ","Employee programme",JOptionPane.INFORMATION_MESSAGE);
			}
		});
...
//				System.out.println(emp);
				try {
					...
					if(emp.isSex()) {
						rdbtn_Male.setSelected(true);
//						System.out.println(emp.isSex()+" nam");
					} else {
						rdbtn_Female.setSelected(true);
//						System.out.println(emp.isSex()+" nữ");
					}
					
					if(emp.isKoj()) {
						rdbtn_fulltime.setSelected(true);
					} else {
						rdbtn_parttime.setSelected(true);
					}
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					if(list.getAllEmployee().isEmpty()) {
						...
						SimpleDateFormat date = new SimpleDateFormat("dd/MM/yyyy");
						JOptionPane.showConfirmDialog(null, "Bạn chắc chắn muốn xóa nhân viên này không?","Delete",0);
...
//		btn_reload.addActionListener(action);
		...
		table = new JTable();
		table.setBounds(10, 461, 1400, 146);
		...
		scrollPane.setBounds(10, 461, 1204, 137);
